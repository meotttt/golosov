...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message_text = (
            ...
            "▎Тут ты можешь принять участие в голосовании в новогодней номинации чата @SUNRlSE_CHAT\n\n"
...
async def main() -> None:
    ...
    application = ApplicationBuilder().token("8514492645:AAFuS6g0UBjzw41TZBz6jHWpNeHIQztbFdo").build()
